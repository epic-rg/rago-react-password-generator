export const HistoryPanel = ({ theme, passwordHistory, setPasswordHistory, setPassword, copyPassword }) => {
  return (
    <div className="mt-5 rounded-xl border p-4" style={{ borderColor: theme.border || theme.secondary, backgroundColor: `${theme.primary}80` }}>
      <div className="mb-2 flex items-center justify-between">
        ...
        <button
          ...
          style={{ borderColor: theme.border || theme.secondary, color: theme.tertiary }}
        >
          Clear
        </button>
      </div>
        ...
        <ul className="space-y-2">
          {passwordHistory.map((item) => (
            <li
              ...
              style={{ borderColor: theme.border || theme.secondary, backgroundColor: `${theme.primary}99` }}
            >
              <button
                type="button"
